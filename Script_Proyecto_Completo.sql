...
CREATE TABLE UNA.TB_COWORKING_SPACES (
    ...
    NAME      VARCHAR2(100) NOT NULL,
    CAPACITY  NUMBER,
    CONSTRAINT FK_COWORKING_SPACE FOREIGN KEY (SPACE_ID)
        REFERENCES UNA.TB_SPACES(ID),
    CONSTRAINT FK_COWORKING_TYPE  FOREIGN KEY (TYPE_ID)
        REFERENCES UNA.TB_SPACE_TYPES(ID)
);
...
CREATE TABLE UNA.TB_RESERVATIONS (
    ...
    CONSTRAINT FK_RESERVATION_USER      FOREIGN KEY (USER_ID)
        REFERENCES UNA.TB_USUARIOS(ID),
    CONSTRAINT FK_RESERVATION_COWORKING FOREIGN KEY (COWORKING_SPACE_ID)
        REFERENCES UNA.TB_COWORKING_SPACES(ID)
);

--------------------------------------------------------
-- ALTER: VERSION EN COWORKING_SPACES
--------------------------------------------------------
ALTER TABLE UNA.TB_COWORKING_SPACES
    ADD VERSION NUMBER(19,0) DEFAULT 0 NOT NULL;
...
-- TB_SPACE_TYPES
CREATE SEQUENCE SPACE_TYPES_SEQ START WITH 1 INCREMENT BY 1;
...
ALTER TABLE TB_SPACES
  ADD FLOOR NUMBER DEFAULT 0;